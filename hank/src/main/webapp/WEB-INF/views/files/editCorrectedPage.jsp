...
<h2><span class="label label-warning">Correction</span> Edit page ${page.page}</h2>

<p style="margin-top: 30px">

</p>

<c:url value="/files/image/${imageId}/${runId}/${correctionId}/page/${page.page}/lines/edit" var="actionUrl" />
